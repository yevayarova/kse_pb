...
"""
Можна використати словник англійських існуючих слів, щоб перевірити чи користувач дійсно вводить слово, бо він може ввести просто набір найпопулярніших літер, типу aeoudb з більшим шансом попасти на літеру із загаданому слові. 
Також можна пояснити користувачу перед початком гри, щоб означає круглі дужки що означають квадратні. 
А ще краще імпортувати бібліотеку colorama і додавати колір для кращого сприйняття.
Можна зберігати статистику і виводити її на консоль, також її можна зберігати не тільки для одного запуску, а у окремий файл і виводити максимальний рейтинг для підняття духу змагання 
Можна додати режими складності, складніші наприклад матимуть слова з більшою кількістю літер. 
Для того щоб нещасна наступна людина не розгрібала наш код пів життя, можна після кожної функції написати коментар що вона робить. 
